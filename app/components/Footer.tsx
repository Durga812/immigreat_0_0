    ...
    return (
      <footer id="contact-us">
        <div className="bg-gray-300 text-gray-800 py-8 px-4">
          <div className="container mx-auto px-4 md:px-10 lg:px-20 flex flex-wrap md:flex-nowrap justify-between items-center">
            <div className="md:w-1/2 mb-6 md:mb-0">
              ...
              <p>Ready to take the next step in your immigration journey? Contact Immigreat.ai today to schedule a consultation and learn how we can help you achieve your green card goals.</p>
            </div>
        ...
        <div className="bg-white text-center py-4">
          <p>All rights reserved by company.ai, All illustrations are used from freepik.com</p>
        </div>
      </footer>
    );
  };
